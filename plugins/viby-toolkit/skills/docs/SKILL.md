...
name: docs
description: >
  Always load before writing prose a human will read — "write the README", "document this", "write
  the PR description", "release notes", "an ADR for this decision", "explain this to the team",
