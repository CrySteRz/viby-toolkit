...
/**
 * viby-toolkit test-quality scanner — the executable half of /viby-toolkit:test.
 *
...
// Deliberately NOT checked mechanically, though /viby-toolkit:test still teaches both:
