...
Follow `/viby-code:principles`. This is a doctrine skill: the guidance below is established
...
Never swallow an exception without logging it (`/viby-code:test` flags this in tests for the
