...
description: >
  ...
  inside /viby-code:review-cluster, which reviews one diff.
---
...
Follow `/viby-code:principles`. Detection is read work — **fan out**. The judgement about
...
the same grounding discipline `/viby-code:review-cluster` applies — quote the line, name a
