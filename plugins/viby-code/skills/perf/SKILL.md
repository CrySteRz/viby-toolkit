...
is built around closing that specific gap. Follow `/viby-code:principles`; profiling is read
...
- **Correctness is a gate, not a footnote.** Run the relevant tests (`/viby-code:verify`).
  ...
  is still correct, write them (`/viby-code:test`).
